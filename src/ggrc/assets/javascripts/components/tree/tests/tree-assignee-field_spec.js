...
describe('GGRC.Components.treeAssigneeField', function () {
  ...
  beforeEach(function () {
    var Component = GGRC.Components.get('treeAssigneeField');
    var init = Component.prototype.viewModel.prototype.init;

    Component.prototype.viewModel.prototype.init = undefined;
    viewModel = GGRC.Components.getViewModel('treeAssigneeField');
